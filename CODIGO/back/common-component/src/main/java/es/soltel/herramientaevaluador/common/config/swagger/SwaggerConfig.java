package es.soltel.herramientaevaluador.common.config.swagger;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		if (profileWAR && !applicationName.equalsIgnoreCase("zuul-server")) {
			docket.pathProvider(extendRelativePathProvider);
		}
